            ...
            >
                <div className="flex-1 flex flex-col justify-start mr-10">
                    ...
                    <p className={`${styles.paragraph} mt-4 max-w-[350px]`}>
                        To'lovlarni oson, ishonchli va xafsiz qilishning yangi
                        usuli.
                    </p>
                </div>
                ...
                <div className="flex-[1.5] w-full flex flex-row justify-between flex-wrap md:mt-0 mt-10">
                    {footerLinks.map((link) => (
                        ...
                        >
                            <h4 className="font-montserrat font-medium text-[18px] leading-[27px] text-wh ite">
                                {link.title}
                            </h4>
                            ...
                            <ul className="list-none mt-4">
                                {link.links.map((item, idx) => (
                                    ...
                                    >
                                        {/* tailwindda hoverni clasnameni ichiga yozib ketsaham bo'larkan */}
                                        {item.name}
                                    </li>
                                ))}
                            </ul>
